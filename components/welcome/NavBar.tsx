...
function NavBar() {
    ...
    return (
        <nav className="pt-6 relative top-0 left-0 w-full justify-between flex px-6 sm:px-10  items-center">
            ...
            <div className="hidden lg:flex group hover:bg-gray-primary py-2 px-4 rounded-lg transition-all duration-500">
                <p className="text-[#a8afbd] font-semibold group-hover:text-white transition-all duration-500">LOG IN</p>
            </div>
            {
                showMenu &&
